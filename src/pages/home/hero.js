    ...
    <div className="grid-element">
      <div className="self-center order-1 col-span-2 mt-12 md:order-1 md:mt-0 dark-base">
        <h1 className="heading-hero">
          ...
          <span className="text-blue-seven font-bold text-4xl dark-nine">
            Assignment
          </span>
        </h1>
        <p className="hidden lg:flex mt-4  text-gray dark-base">
          Assignment management dashboard is a simple dashboard to manage the
          assignment of the students and teachers of any Institute.
        </p>
      </div>

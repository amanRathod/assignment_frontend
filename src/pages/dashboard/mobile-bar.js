  ...
  return (
    <div className="flex items-center justify-between px-4 py-2 text-purple-one bg-purple-nine lg:hidden">
      <button
        ...
        className="focus:outline-none focus:ring-2 focus:ring-purple-two focus:ring-opacity-60"
      >
        <svg
          className="w-6 h-6"
          fill="currentColor"
      ...
      <button
        type="submit"
        className="flex flex-row items-center justify-center space-x-2 xl:justify-start focus:outline-none focus:ring-2 focus:ring-purple-two focus:ring-opacity-60"
      >
